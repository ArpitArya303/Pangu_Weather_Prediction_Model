...
python prediction.py \
    ...
    --model_path /storage/arpit/Pangu/Logs/exp_19var/run_100epoch_64b/best_model.pth \
    --transform_dir /storage/arpit/Pangu/Pangu_Weather_Prediction_Model/pangu/data/test_19var \
    --output_path /storage/arpit/Pangu/Pangu_Weather_Prediction_Model/pangu/prediction/exp_19var/100epoch_64b \
