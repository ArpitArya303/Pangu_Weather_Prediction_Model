...
python prediction.py \
    ...
    --model_path /storage/arpit/Pangu/Logs/exp_20var/run_200epoch_128b_2gpu/best_model.pth \
    --transform_dir /storage/arpit/Pangu/Pangu_Weather_Prediction_Model/pangu/data/test_20var \
    --output_path /storage/arpit/Pangu/Pangu_Weather_Prediction_Model/pangu/prediction/exp_20var/200epoch_128b_2gpu \
